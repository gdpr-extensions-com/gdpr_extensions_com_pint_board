...
var _2ClickIframePrivacy = new function() {
  ...
  this.types = new Array(
    {
      type: 'board',
      description: 'Zum Aktivieren des Boards bitte auf den Link klicken. Durch das Aktivieren von eingebetteten Boards werden Daten an den jeweiligen Anbieter übermittelt. Weitere Informationen können unserer Datenschutzerklärung entnommen werden.<br />'
    },
    {
      type: 'map',
