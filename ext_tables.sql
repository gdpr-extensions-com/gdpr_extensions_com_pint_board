...
CREATE TABLE tt_content (
	gdpr_pinterest_board_url varchar(255) NOT NULL DEFAULT '',
	pin_board_width int(11) NOT NULL DEFAULT '0',
	scale_board_height int(11) NOT NULL DEFAULT '0',
	scale_board_width int(11) NOT NULL DEFAULT '0',
);
